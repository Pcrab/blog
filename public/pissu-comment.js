const $e = (e, t) => e === t, Ae = Symbol("solid-track"), B = {
  equals: $e
};
let ue = ge;
const O = 1, U = 2, ce = {
...
var g = null;
let Q = null, m = null, C = null, E = null, D = 0;
function q(e, t) {
  const n = m, r = g, s = e.length === 0, o = t === void 0 ? r : t, l = s ? ce : {
    owned: null,
    cleanups: null,
...
function j(e, t, n) {
  ...
  const r = ee(e, t, !0, 0);
  return r.observers = null, r.observerSlots = null, r.comparator = n.equals || void 0, L(r), fe.bind(r);
}
function P(e) {
  if (m === null)
    return e();
...
function de(e, t, n) {
  ...
  return (!e.comparator || !e.comparator(r, t)) && (e.value = t, e.observers && e.observers.length && R(() => {
    for (let s = 0; s < e.observers.length; s += 1) {
      const o = e.observers[s], l = Q && Q.running;
      l && Q.disposed.has(o), (l ? !o.tState : !o.state) && (o.pure ? C.push(o) : E.push(o), o.observers && pe(o)), l || (o.state = O);
    }
    if (C.length > 1e6)
      throw C = [], new Error();
  }, !1)), t;
...
function Oe(e, t, n) {
  ...
  try {
    ...
    return e.pure && (e.state = O, e.owned && e.owned.forEach(J), e.owned = null), e.updatedAt = n + 1, he(l);
  } finally {
    m = o, g = s;
  }
  (!e.updatedAt || e.updatedAt <= n) && (e.updatedAt != null && "observers" in e ? de(e, r) : e.value = r, e.updatedAt = n);
}
function ee(e, t, n, r = O, s) {
  ...
  return g === null || g !== ce && (g.owned ? g.owned.push(o) : g.owned = [o]), o;
}
function F(e) {
  if (e.state === 0)
    return;
...
function H(e, t) {
  ...
  for (let n = 0; n < e.sources.length; n += 1) {
    ...
    if (r.sources) {
      const s = r.state;
      s === O ? r !== t && (!r.updatedAt || r.updatedAt < D) && F(r) : s === U && H(r, t);
    }
  }
}
function pe(e) {
  for (let t = 0; t < e.observers.length; t += 1) {
    ...
    n.state || (n.state = U, n.pure ? C.push(n) : E.push(n), n.observers && pe(n));
  }
}
function J(e) {
  let t;
...
function Re(e, t, n = {}) {
  let r = [], s = [], o = [], l = 0, i = t.length > 1 ? [] : null;
  return Se(() => se(o)), () => {
    let u = e() || [], c, a;
    return u[Ae], P(() => {
      let d = u.length, b, p, v, z, y, h, f, w, _;
      if (d === 0)
        l !== 0 && (se(o), o = [], r = [], s = [], l = 0, i && (i = [])), n.fallback && (r = [Le], s[0] = q((K) => (o[0] = K, n.fallback())), l = 1);
      else if (l === 0) {
        for (s = new Array(d), a = 0; a < d; a++)
          r[a] = u[a], s[a] = q(x);
        l = d;
      } else {
        for (v = new Array(d), z = new Array(d), i && (y = new Array(d)), h = 0, f = Math.min(l, d); h < f && r[h] === u[h]; h++)
          ;
        for (f = l - 1, w = d - 1; f >= h && w >= h && r[f] === u[w]; f--, w--)
          v[w] = s[f], z[w] = o[f], i && (y[w] = i[f]);
        for (b = /* @__PURE__ */ new Map(), p = new Array(w + 1), a = w; a >= h; a--)
          _ = u[a], c = b.get(_), p[a] = c === void 0 ? -1 : c, b.set(_, a);
        for (c = h; c <= f; c++)
          _ = r[c], a = b.get(_), a !== void 0 && a !== -1 ? (v[a] = s[c], z[a] = o[c], i && (y[a] = i[c]), a = p[a], b.set(_, a)) : o[c]();
        for (a = h; a < d; a++)
          a in v ? (s[a] = v[a], o[a] = z[a], i && (i[a] = y[a], i[a](a))) : s[a] = q(x);
...
function Y(e) {
  ...
  return j(
    () => {
      ...
      if (r) {
        const s = e.children;
        return typeof s == "function" && s.length > 0 ? P(
          () => s(
            t ? r : () => {
              if (!P(n))
                throw Ke("Show");
...
function qe(e, t, n) {
  let r = n.length, s = t.length, o = r, l = 0, i = 0, u = t[s - 1].nextSibling, c = null;
  for (; l < s || i < o; ) {
    if (t[l] === n[i]) {
      l++, i++;
      continue;
    ...
    if (s === l) {
      ...
      e.insertBefore(n[i++], t[l++].nextSibling), e.insertBefore(n[--o], a), t[s] = n[o];
    } else {
      if (!c) {
        c = /* @__PURE__ */ new Map();
        let x = i;
      ...
      if (a != null)
        if (i < a && a < o) {
          let x = l, d = 1, b;
          for (; ++x < s && x < o && !((b = c.get(t[x])) == null || b !== a + d); )
            d++;
          if (d > a - i) {
            const p = t[l];
            for (; i < a; )
...
function I(e, t, n) {
  ...
  }, o = t ? () => P(() => document.importNode(r || (r = s()), !0)) : () => (r || (r = s())).cloneNode(!0);
...
function ye(e, t, n = {}) {
  ...
  for (o = 0, l = r.length; o < l; o++) {
    const i = r[o], u = !!t[i];
    !i || i === "undefined" || n[i] === u || !u || (ie(e, i, !0), n[i] = u);
  }
  return n;
}
function $(e, t, n, r) {
...
function V(e, t, n, r, s) {
  ...
  if (e = l && n[0] && n[0].parentNode || e, o === "string" || o === "number")
    if (o === "number" && (t = t.toString()), l) {
      let i = n[0];
      i && i.nodeType === 3 ? i.data = t : i = document.createTextNode(t), n = T(e, n, r, i);
    } else
    ...
    if (Array.isArray(t)) {
      ...
      if (Z(i, t, n, s))
        return A(() => n = V(e, i, n, r, !0)), () => n;
      if (i.length === 0) {
        if (n = T(e, n, r), l)
          return n;
      } else
        u ? n.length === 0 ? le(e, i, r) : qe(e, n, i) : (n && T(e), le(e, i));
      n = i;
    } else if (t.nodeType) {
      if (Array.isArray(n)) {
        if (l)
  ...
  if (t.length) {
    ...
    for (let l = t.length - 1; l >= 0; l--) {
      ...
      if (s !== i) {
        ...
        !o && !l ? u ? e.replaceChild(s, i) : e.insertBefore(s, n) : u && i.remove();
      } else
        o = !0;
    }
  } else
...
function Fe(e) {
  return Object.keys(e).reduce((n, r) => {
    const s = e[r];
    return n[r] = Object.assign({}, s), xe(s.value) && !Ge(s.value) && !Array.isArray(s.value) && (n[r].value = Object.assign({}, s.value)), Array.isArray(s.value) && (n[r].value = s.value.slice(0)), n;
  }, {});
}
function He(e) {
  return e ? Object.keys(e).reduce((n, r) => {
    const s = e[r];
    return n[r] = xe(s) && "value" in s ? s : {
      value: s
    }, n[r].attribute || (n[r].attribute = Je(r)), n[r].parse = "parse" in n[r] ? n[r].parse : typeof n[r].value != "string", n;
  }, {}) : {};
}
function Ve(e) {
...
function De(e, t) {
  ...
  return Object.keys(t).forEach((s) => {
    const o = n[s], l = e.getAttribute(o.attribute), i = e[s];
    l && (o.value = o.parse ? me(l) : l), i != null && (o.value = Array.isArray(i) ? i.slice(0) : i), o.reflect && ae(e, o.attribute, o.value), Object.defineProperty(e, s, {
      get() {
        return o.value;
      },
      set(u) {
        const c = o.value;
        o.value = u, o.reflect && ae(this, o.attribute, o.value);
        for (let a = 0, x = this.__propertyChangedCallbacks.length; a < x; a++)
  ...
  return class extends e {
    ...
    connectedCallback() {
      if (this.__initialized)
        return;
      this.__releaseCallbacks = [], this.__propertyChangedCallbacks = [], this.__updating = {}, this.props = De(this, t);
      const s = Ve(this.props), o = this.Component, l = W;
      try {
        W = this, this.__initialized = !0, Qe(o) ? new o(s, {
          element: this
        }) : o(s, {
          element: this
        });
    ...
    lookupProp(s) {
      if (t)
        return n.find((o) => s === o || s === t[o].attribute);
    }
    get renderRoot() {
...
function Xe(e, t = {}, n = {}) {
  ...
  return (o) => {
    ...
    return l ? (l.prototype.Component = o, l) : (l = We(r, He(t)), l.prototype.Component = o, l.prototype.registeredTag = e, customElements.define(e, l, s), l);
  };
}
function Ye(e) {
...
function et(e) {
  return (t, n) => {
    ...
    return q((s) => {
      const o = Ye(t);
      r.addPropertyChangedCallback((i, u) => o[i] = u), r.addReleaseCallback(() => {
...
const lt = /* @__PURE__ */ I('<div class="text-gray-800 dark:text-gray-200"><div class="flex gap-2 mb-1rem flex-col sm:flex-row"><input class="flex-1 font-mono p-0.5rem border-1px rounded-0.25rem outline-none bg-gray-200 dark:bg-gray-700"placeholder=昵称><input class="flex-1 font-mono p-0.5rem border-1px rounded-0.25rem outline-none bg-gray-200 dark:bg-gray-700"type=email placeholder=邮箱（可选）><input class="flex-1 font-mono p-0.5rem border-1px rounded-0.25rem outline-none bg-gray-200 dark:bg-gray-700"type=url placeholder=个人站点（可选）></div><div class=flex><textarea class="bg-gray-200 dark:bg-gray-700 flex-1 min-h-2rem h-4rem font-size-1rem font-weight-400 p-0.5rem resize-y rounded-0.5rem"placeholder=说点什么...></textarea></div><div class="flex flex-row-reverse mt-0.5rem"><button class="font-size-1rem border-none m-0 px-1rem py-0.5rem rounded-0.5rem duration-300">回复'), Ce = (e) => {
  const {
    url: t,
    setNeedReq: n
  } = ve(), [r, s] = k(localStorage.getItem("pissu-username") ?? ""), [o, l] = k(localStorage.getItem("pissu-email") ?? ""), [i, u] = k(localStorage.getItem("pissu-site") ?? ""), [c, a] = k(localStorage.getItem("pissu-content") ?? ""), [x, d] = k(!1), b = j(() => !!r() && !!c() && !x()), p = (y, h, f) => {
    localStorage.setItem(`pissu-${y}`, f), h(f);
  }, v = (y, h) => (f) => p(y, h, f.target.value), z = () => {
    b() && (d(!0), fetch(`${t}/api/comment`, {
      method: "POST",
      headers: {
  ...
  return (() => {
    const y = lt(), h = y.firstChild, f = h.firstChild, w = f.nextSibling, _ = w.nextSibling, K = h.nextSibling, te = K.firstChild, _e = K.nextSibling, G = _e.firstChild;
    return M(f, "input", v("username", s), !0), M(w, "input", v("email", l), !0), M(_, "input", v("site", u), !0), M(te, "input", v("content", a), !0), G.$$click = z, A((N) => {
      const ne = !b(), ke = {
        "@hover:bg-gray-200 @hover:dark:bg-gray-700 bg-gray-300 dark:bg-gray-600 text-gray-700 dark:text-gray-300 cursor-pointer": b(),
        "bg-gray-200 dark:bg-gray-700 text-gray-300 dark:text-gray-600 cursor-not-allowed": !b()
      };
      return ne !== N._v$ && (G.disabled = N._v$ = ne), N._v$2 = ye(G, ke, N._v$2), N;
    }, {
      _v$: void 0,
      _v$2: void 0
    }), A(() => f.value = r()), A(() => w.value = o()), A(() => _.value = i()), A(() => te.value = c()), y;
  })();
};
be(["input", "click"]);
const at = /* @__PURE__ */ I('<div class="pl-0.5rem b-l-solid b-l-gray-500 text-gray-500 break-words"><span class="ml-1rem text-gray-500 font-size-0.9rem cursor-pointer">原文'), ut = /* @__PURE__ */ I('<div class=transition><div><p class="m-0 font-size-1.2rem font-bold"></p><p class="m-0 font-size-0.9rem font-light text-gray-700 dark:text-gray-200"></p></div><div class=mb-0.5rem><p class="m-0 break-words"></p><span class="mb-0.5rem text-gray-500 font-size-0.9rem cursor-pointer">回复'), ct = (e) => {
  const {
    displayEditorAt: t,
  ...
  return (() => {
    const c = ut(), a = c.firstChild, x = a.firstChild, d = x.nextSibling, b = a.nextSibling, p = b.firstChild, v = p.nextSibling, z = v.firstChild;
    return $(x, () => l.Username), $(d, () => it(l.CreateAt)), $(b, S(Y, {
      when: i,
      get children() {
        const y = at(), h = y.firstChild;
        return $(y, i, h), h.$$click = () => {
          var _;
          s(u);
          const f = document.querySelector(`#${o}`), w = (_ = f == null ? void 0 : f.shadowRoot) == null ? void 0 : _.querySelector(`[data-comment-id="${u}"]`);
          w == null || w.scrollIntoView({
            behavior: "smooth"
          });
        }, y;
      }
    }), p), $(p, () => l.Content), v.$$click = () => l.CommentId === t() ? n(0) : n(l.CommentId), $(v, () => t() === l.CommentId ? "收起" : "展开", z), $(c, S(Y, {
      get when() {
      ...
      const h = {
        "bg-gray-200 dark:bg-gray-800": r() === l.CommentId
      }, f = l.CommentId;
      return y._v$ = ye(c, h, y._v$), f !== y._v$2 && Be(c, "data-comment-id", y._v$2 = f), y;
    }, {
      _v$: void 0,
      _v$2: void 0
    }), c;
...
const ft = /* @__PURE__ */ I("<div>"), dt = (e) => {
  ...
  return (() => {
    ...
    return $(n, S(Me, {
      ...
      children: (r) => S(ct, {
        ...
        get replyContent() {
          var s;
          return (s = t().find((o) => o.CommentId === r.Reply)) == null ? void 0 : s.Content;
        }
      })
    })), n;
  })();
                ...
                outline: none;
                color: inherit;
            }`), pt = /* @__PURE__ */ I('<div class="text-center text-gray-500 dark:text-gray-200">加载中...'), ht = (e) => {
  const {
    url: t,
    id: n
  } = e, [r, s] = k(0), [o, l] = k(0), [i, u] = k([]), [c, a] = k(!0), [x, d] = k(!1);
  re(async () => {
    if (c()) {
      a(!1), d(!0);
      try {
  ...
  return re(() => {
    const p = o();
    p !== 0 && (clearTimeout(b), b = setTimeout(() => {
      p === o() && l(0);
    }, 500));
  }), [(() => {
    const p = gt(), v = p.firstChild;
    return $(p, nt, v), p;
  })(), S(we.Provider, {
    value: {
      id: n,
